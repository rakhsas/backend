...
const setAuthCookies = (
	res: Response,
	{
		aToken = '',
		rToken = '',
		aTokenMaxAgeSeconds = parseInt(
			process.env.ATOKEN_VALIDITY_DURATION_IN_SECONDS || '',
		),
		rTokenMaxAgeSeconds = parseInt(
			process.env.RTOKEN_VALIDITY_DURATION_IN_SECONDS || '',
		),
...
export const googleAuthentication = async (req: Request, res: Response) => {
	...
	return res.redirect(`${clientUrl}/dashboard/overview`);
};
